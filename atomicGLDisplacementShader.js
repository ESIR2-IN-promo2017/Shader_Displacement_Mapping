...
atomicGLDisplacementShader = function(nname, agl,fragmentShaderID, vertexShaderID,nnbLights){
	// attributes
	// -------------------------------------------------
	// name
	this.name = nname ;
    ...
    this.setHeightMap = function setHeightMap(heightMap)
    {
        //TODO
    }

    this.setNormalMap = function setNormalMap(normalMap)
    {
